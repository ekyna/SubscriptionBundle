...
return static function (ContainerConfigurator $container) {
    ...
    // Renewal calculator
    $services->set('ekyna_subscription.calculator.renewal', RenewalCalculator::class);
    ...
    // Subscription mailer
    $services
        ->set('ekyna_subscription.mailer', Mailer::class)
        ->args([
            service('router'),
    ...
    // Subscription notifier (reminder)
    $services
    ...
    $services
        ->set('ekyna_subscription.message_handler.notify', NotifyHandler::class)
        ->args([
            service('ekyna_subscription.repository.subscription'),
            service('ekyna_subscription.repository.reminder'),
            service('ekyna_subscription.notifier'),
        ])
    ...
    // Remind subscriptions command
    $services
        ->set('ekyna_subscription.command.remind', RemindSubscriptionsCommand::class)
        ->args([
            service('ekyna_subscription.repository.reminder'),
            service('ekyna_subscription.repository.subscription'),
